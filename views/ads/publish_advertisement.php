                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="Location" id="location" required class="form-control">
                                        ...
                                        ?>
                                        <option value="#" style="background-color: #ccc; color: #5c5c5c; font-weight: bold; font-size: 13px;" disabled><?php echo "- ".$district->name." -" ?></option>
                                        
                                        <?php 
                                            $cities = City::getByDistric($district->id);
